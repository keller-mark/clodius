...
def tileset_info(filename):
    ...
    ----------
    filename: str
      The filename of the zarr file containing the tileset info.
    ...
    if "row_infos" in f["resolutions"][str(resolutions[0])].attrs:
        ...
        tileset_info["row_infos"] = row_infos
    elif "row_infos" in f["info"].attrs:
        row_infos = f["info"].attrs["row_infos"]
        tileset_info["row_infos"] = row_infos
